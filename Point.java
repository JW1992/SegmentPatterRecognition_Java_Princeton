...
public class Point implements Comparable<Point> {
    ...
    public int compareTo(Point that) {
        /* YOUR CODE HERE */
        int nDiff = this.y-that.y;
        if(nDiff==0) nDiff = this.x-that.x;
        return nDiff;
    }
    ...
    public Comparator<Point> slopeOrder() {
        /* YOUR CODE HERE */
        return new SlopeOrderSort();
    }
    public class SlopeOrderSort implements Comparator<Point>
    {
    	@Override
 ...
 */
    ...
    public static void main(String[] args) {
		...
		//LineSegment tempSegment = new LineSegment(points[0], points[1]);
		//tempSegment.draw();
    	//StdDraw.show();
